...
* Open `00-practice-app/src/components/Display.js` in your IDE and explain the following:
  ...
  * Inside the `Display` component, we have an object called `feline`. Each object within that array contains the `name` and `description` of kittens:
...
* Open `00-practice-app/src/components/Display.js` in your IDE and explain the following:
  ...
  * A card is populated with the `feline` properties pass to the `Card` component as props -- specifically, the `name`, `description`, `id` props.

...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, read the [Apollo documentation on the context argument](https://www.apollographql.com/docs/apollo-server/v3/data/resolvers/#the-context-argument), and stay for office hours to ask for help.

...
* Break your students into pairs that will work together on this activity.
     ...
     * [Apollo Docs on getting started with Apollo Server](https://www.apollographql.com/docs/apollo-server/v3/getting-started/)
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, read the [Apollo Docs on resolvers](https://www.apollographql.com/docs/apollo-server/v3/data/resolvers/) and the [Apollo Docs on schema basics](https://www.apollographql.com/docs/apollo-server/v3/schema/schema/), and stay for office hours to ask for help.
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, read the [Apollo Docs on handling arguments](https://www.apollographql.com/docs/apollo-server/v3/data/resolvers/#handling-arguments), and stay for office hours to ask for help.

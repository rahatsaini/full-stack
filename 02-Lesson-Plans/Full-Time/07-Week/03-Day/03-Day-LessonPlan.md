...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, read the [Sequelize documentation on Models](https://sequelize.org/api/v6/class/src/model.js~model), and stick around for office hours to ask for help.

...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, read the [Apollo Docs on getting started with Apollo Server](https://www.apollographql.com/docs/apollo-server/v3/getting-started/), and stay for office hours to ask for help.
